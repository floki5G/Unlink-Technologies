...
import { CreateTutorialApi, GetTutoriallsApi } from "../../../services/apis/apis";
...
export function Tutorials() {
  ...
  async function handelCreateTutorialls(events:
  ...
  return (
    <div className="">
      <Sidebar
        id='tutorialls'
        heading='Tutorials'
        descripiton='Tutorials'>
        <form className="max-w-md "
          onSubmit={handelCreateTutorialls}
        >
          ...
          <div className="relative z-0 w-full mb-5 group">
            <input
              ...
              type="text" name="tutorials_name" id="tutorials_name" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" required />
            <label htmlFor="tutorials_name" className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
              tutorials  name
            </label>
          </div>
      ...
      <div className="flex gap-4">
        ...
        {tutorialsList?.map((item, index) => (
          <button
            ...
            className="block p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 "
            onClick={() => {
